import {
  ...
  watchPublicClient,
  writeContract
} from "./chunk-55CS3DZS.js";
import {
  custom,
  http,
  webSocket
} from "./chunk-5A5UDRSN.js";
import "./chunk-B3635NC2.js";
import "./chunk-QC4SCIPE.js";
import "./chunk-3VYO4JVJ.js";
import "./chunk-KASMAJTU.js";
import "./chunk-VW7X5TWR.js";
import "./chunk-AWR5F2B6.js";
import "./chunk-NZK4BEXV.js";
import "./chunk-GEEVCR2I.js";
import "./chunk-X2C2A62L.js";
...
var FocusManager = (_a2 = class extends Subscribable {
  ...
  isFocused() {
    ...
    return ((_a6 = globalThis.document) == null ? void 0 : _a6.visibilityState) !== "hidden";
  }
    ...
    if (options.placeholderData !== void 0 && data === void 0 && status === "pending") {
      ...
      if ((prevResult == null ? void 0 : prevResult.isPlaceholderData) && options.placeholderData === (prevResultOptions == null ? void 0 : prevResultOptions.placeholderData)) {
        ...
        placeholderData = typeof options.placeholderData === "function" ? options.placeholderData(
          (_a6 = __privateGet(this, _lastQueryWithDefinedData)) == null ? void 0 : _a6.state.data,
...
function infiniteQueryBehavior(pages) {
  return {
    onFetch: (context, query) => {
      ...
      const direction = (_c = (_b = (_a6 = context.fetchOptions) == null ? void 0 : _a6.meta) == null ? void 0 : _b.fetchMore) == null ? void 0 : _c.direction;
      ...
      if (context.options.persister) {
        context.fetchFn = () => {
          var _a7, _b2;
          return (_b2 = (_a7 = context.options).persister) == null ? void 0 : _b2.call(
            _a7,
            fetchFn,
            {
              client: context.client,
...
function getPreviousPageParam(options, { pages, pageParams }) {
  var _a6;
  return pages.length > 0 ? (_a6 = options.getPreviousPageParam) == null ? void 0 : _a6.call(options, pages[0], pages, pageParams[0], pageParams) : void 0;
}
...
var InfiniteQueryObserver = class extends QueryObserver {
  ...
  createResult(query, options) {
    ...
    const fetchDirection = (_b = (_a6 = state.fetchMeta) == null ? void 0 : _a6.fetchMore) == null ? void 0 : _b.direction;
...
var MutationObserver = (_a5 = class extends Subscribable {
  ...
  setOptions(options) {
    ...
    if ((prevOptions == null ? void 0 : prevOptions.mutationKey) && this.options.mutationKey && hashKey(prevOptions.mutationKey) !== hashKey(this.options.mutationKey)) {
      this.reset();
    } else if (((_a6 = __privateGet(this, _currentMutation)) == null ? void 0 : _a6.state.status) === "pending") {
  ...
  onUnsubscribe() {
    var _a6;
    if (!this.hasListeners()) {
      (_a6 = __privateGet(this, _currentMutation)) == null ? void 0 : _a6.removeObserver(this);
    }
  }
  ...
  var _a6;
  const state = ((_a6 = __privateGet(this, _currentMutation)) == null ? void 0 : _a6.state) ?? getDefaultState();
  ...
  notifyManager.batch(() => {
    ...
    if (__privateGet(this, _mutateOptions) && this.hasListeners()) {
      ...
      if ((action == null ? void 0 : action.type) === "success") {
        (_b = (_a6 = __privateGet(this, _mutateOptions)).onSuccess) == null ? void 0 : _b.call(
          _a6,
          action.data,
          variables,
          onMutateResult,
  ...
  return {
    async queryFn({ queryKey }) {
      ...
      for (let i = 0; i < length; i++) {
        ...
        const abi = ((_a6 = options.contracts) == null ? void 0 : _a6[i]).abi;
...
function useBaseQuery(options, Observer, queryClient) {
  ...
  (_b = (_a6 = client.getDefaultOptions().queries) == null ? void 0 : _a6._experimental_beforeQuery) == null ? void 0 : _b.call(
    _a6,
    defaultedOptions
  );
  if (true) {
